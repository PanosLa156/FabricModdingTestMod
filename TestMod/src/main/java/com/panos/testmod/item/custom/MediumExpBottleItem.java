...
public class MediumExpBottleItem extends Item implements ProjectileItem{


    public MediumExpBottleItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            smallExpBottleEntity.setVelocity(user, user.getPitch(), user.getYaw(), -15.0F, 0.6F, 1.0F);
